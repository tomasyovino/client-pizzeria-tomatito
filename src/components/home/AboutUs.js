        ...
        <section className="container mx-auto py-8 px-2 flex flex-col items-center justify-center relative lg:flex-row lg:px-8 lg:justify-between">
            <div className="w-full mb-2 lg:w-1/3">
                ...
                <div className="w-full flex items-center gap-2 mb-7">
                    ...
                    <p>Martes - Domingo | 19.00 - 23.00</p>
                </div>
            ...
            <div className="w-full lg:w-2/3 relative flex lg:justify-end">
                <img src={aboutUs} alt="Walter White eating pizza" className="shadow-lg shadow-gray-400 pointer-events-none" />
                <span className="absolute text-white font-semibold text-xl top-16 right-1 md:text-4xl md:top-24 md:right-16">Maestros de la cocina</span>
            </div>
        </section>
    );
};
